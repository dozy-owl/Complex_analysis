...
\textbfit{Теорема} (Руше/ <<Дамы с собычкой>>). Пусть $g, \ f \in \mathcal{O}(D), \ \overline{G}$ -- ограниченная, $\overline{G} \subset D, \ \partial G$ состоит из одной кусочно-гладкой замкнутой жордановой кривой.
Пусть $|f|>|g|$ на $\partial G$. Тогда $N(f+g, G) = N(f, G)$.
\[\triangleright \ N(f+g, G) = \frac{1}{2\pi} \Delta_{\partial G} \arg (f+h)\]
...
\textbfit{Теорема} (критерий локальной однолистности). Пусть $f \in \mathcal{O}(a).$ Тогда $f$ лкально однолистна в $a$ (т.е. $\exists U_\delta(a)$, в которой $f$ -- инъекция) $\Leftrightarrow f'(a) \neq 0.$
