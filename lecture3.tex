...
\[(\Leftarrow) f(z_0+\Delta z)-f(z_0) = \frac{\partial f}{\partial z} \Delta z + \frac{\partial f}{\partial \overline{z}} \Delta \overline{z}+\overline{o}(\Delta z) = \frac{\partial f}{\partial z}\Delta z + \overline{o}(\Delta z) \Rightarrow\]
...
\[(\Leftarrow) \Delta f = \frac{\partial f}{\partial z}\Delta z. +\frac{\partial f}{\partial \overline{z}}\Delta \overline{z}+\overline{o}(\Delta z) = (1)\]
\[\arg \Delta z = \theta, \ \Delta z = te^{i\theta}\]
\[\Delta \overline{z} = \Delta z e^{-2i\theta}\]
\[(1) = \Delta z \left(\frac{\partial f}{\partial z} + e^{-2i\theta} \frac{\partial f}{\partial \overline{z}}\right)+\overline{o}(\Delta z)=\Delta z f'_\theta (z_0) +\overline{o}(\Delta z)\]
...
\[\Rightarrow \frac{\partial f}{\partial \overline{z}} = 0 \text{, т.е. Коши-Римана.}\]
\textbfit{Пр.} 1) $z=x+iy$
\[\left(\begin{array}{ll}
1 & 0 \\
0 & 1    
