...
\textbfit{Теорема.} Пусть $f: D \to \overline{\mathbb{C}}, D \subset \overline{\mathbb{C}}, \ f-$ конформно в $D$. $\partial D = \gamma, f\in C(D), f(\gamma) = \overline{\gamma}, \gamma \ -$ жорданова кривая. $f(\gamma)=\overline\gamma \ -$ биекция. $\overline\gamma = \partial G, G \ -$ область, $\exists z_0\in D: f(z_0)\in G.$ Тогда $f(D)=G$.
