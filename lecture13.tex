...
\textbfit{Опр.} Пусть $a -$ плюс $f(z)$. Тогда порядком полюса в т. $a$ называется порядком нуля вункции $\frac{1}{f}$ в т. $a$.
...
\textbfit{Теорема.} Пусть $f$ мероморфна в $\mathbb{C}, \ \infty -$ ИОТ в $f$. Усли $\infty -$ УОТ или полюс, то $f -$ рациональная.
