...
\subsection{Связь ряда Лорана с типом ИОТ}
...
\textbfit{Следствие.} $a$ -- СОТ $f \Leftrightarrow$ в главной части ряда Лорана $f$ в $\mathring{U}_\epsilon(a)$ бесконечно много ненулевых слагаемых.
...
\textbf{Связь типа ИОТ в $\infty$ с рядом Лорана в $|z| > R$}
...
\[\triangleright \text{ У $f$ конечно полюсов в } \mathbb{C}, \{a_1, \ldots, a_N\} = M\]
\[\text{В окрестности }a_k f = \sum_{n=0}^\infty c_{nk}(z-a_k)^n + \sum_{n=-N_k}^{-1} c_{nk}(z-a_k)^n\]
\[\sum_{n=-N_k}^{-1} c_{nk}(z-a_k)^n = R_k \in \mathcal{O}(\mathbb{C} \setminus \{a_k\})\]
\[f - R_k(z) \in \mathcal{O}(U_\epsilon(a_k))\]
