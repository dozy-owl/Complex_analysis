\section{Лекция 11. Теорема единственности. Теорема Вейерштрасса}
...
\textbfit{Теорема} (о единственности)

Пусть $f, g \in \mathcal{O}(D), f \overset{E}{g}, \ E \subset D, E $ имеет предельную точку в $D.$ Тогда $f \overset{D}{=} g.$
...
\textbfit{Замечание} Теорема Лагранжа не существует в комплексном анализе

\textbfit{Теорема} (Вейерштрасса)

Пусть $f_n \in \mathcal{O}(D)$. Пусть $\forall K \subset D, K$ -- компакт $f_n \overset{K}{\rightrightarrows} f$ (меньше, чем сходимость на всей $D$). Тогда
...
\textbfit{Теорема} (Рунге)

Пусть $D -$ односвязная область. $f \in \mathcal{O}(D)$. Тогда $\exists P_n -$ последовательность многочленов: $\forall F \subset D, K -$ компакт $P_n \overset{K}{\rightrightarrows} f$.
