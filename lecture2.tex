...
\[f(z_0+\Delta z)-f(z_0)=A\Delta x+B\Delta y + i(C\Delta x + D\Delta y)+o(\Delta z) = \left|\begin{array}{ll}
    \Delta x = \frac{\Delta z + \Delta \overline{z}}{2} \\
    \Delta y = \frac{\Delta z - \Delta \overline{z}}{2i}
\end{array}\right| =\]
